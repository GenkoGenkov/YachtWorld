...
namespace YachtWorld.Infrastructure.Migrations
{
    ...
    [Migration("20221211155632_ChangeEmailToPhoneNumberForYachtBroker")]
    partial class ChangeEmailToPhoneNumberForYachtBroker
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YachtWorld.Infrastructure.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "9c6c5a0f-e1fb-4103-9815-5563da158ee4",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEFk2ZnHnn/X84wr6VV32t/cWK6zS0zrCPnotqHzbc/83eGw2hz/Zy/YM7peFLmromg==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b9b28bea-5524-498c-ae00-a2f3a084e8ac",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEHB8MRxnnRQoXM1KMwzdE8p9xYBMygTjQHWUlgN1vsWfsGJXrR5LdzdC7RVaQsm2mw==",
                            PhoneNumberConfirmed = false,
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("YachtWorld.Infrastructure.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("YachtWorld.Infrastructure.Data.Yacht", b =>
                {
                    ...
                    b.HasOne("YachtWorld.Infrastructure.Data.ApplicationUser", "Sailor")
                        .WithMany()
            ...
            modelBuilder.Entity("YachtWorld.Infrastructure.Data.YachtBroker", b =>
                {
                    b.HasOne("YachtWorld.Infrastructure.Data.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
